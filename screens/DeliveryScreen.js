  ...
  return (
    <View className="bg-[#00CCBB] flex-1">
      <SafeAreaView className="z-50">
        ...
        <MapView
            initialRegion={{
                latitude: restaurant.lat, // coordinates
                longitude: restaurant.long, // coordinates
        ...
        <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28 pb-6">
            <Image 
                source={{
            ...
            <View className="flex-1">
                <Text className="text-lg">Darius Horvath</Text>
